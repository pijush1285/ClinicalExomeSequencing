...
#--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H57/ \
...
#--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H59/ \
...
--RGID Novaseq-II \
--RGSM H61_SureSelectClinicalExome \
--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H61/ \
--output-file-prefix H61_SureSelectClinicalExome \
--qc-coverage-region-1 /data1/ngc/dragen1/NIRRH/S30409818_hs_hg38/S30409818_Covered.bed \
--qc-coverage-reports-1 full_res \
--enable-duplicate-marking true \
...
--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H62/ \
...
--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H63/ \
...
--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H69/ \
...
--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H71/ \
...
--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H72/ \
...
--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H75/ \
...
--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H76/ \
...
--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H78/ \
...
--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H82/ \
...
--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H83/ \
...
--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H84/ \
...
--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H85/ \
...
--output-directory /data1/ngc/dragen1/NIRRH/AllVCFs15.10.20/H90/ \
